...
export const canisterId = process.env.CANISTER_ID_EVM_RPC;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./evm_rpc.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the evm_rpc canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./evm_rpc.did.js")._SERVICE>}
 */
export const evm_rpc = createActor(canisterId);
